...
if [ "$WEST_CURRENT_SEG_INITPOINT_TYPE" = "SEG_INITPOINT_CONTINUES" ]; then
 ...
 #ln -sv $WEST_SIM_ROOT/gromacs_config/reference.pdb ./reference.pdb
...
mpiexec -np 1 --oversubscribe $GMX mdrun -s seg.tpr -o seg.trr -c seg.gro -e seg.edr \
...
rm -f md.mdp md_out.mdp topol.top parent.gro parent.trr seg.cpt \
  seg.pdb seg.tpr
