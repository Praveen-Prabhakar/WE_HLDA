...
N=28                   # Number of descriptors
Row_skip=0            # Skip <Row_skip> lines at the beginning (e.g. equilibration time)
Npoints=50            # Check convergence of the coefficintes taking <Npoints> chunks of the trajectory
